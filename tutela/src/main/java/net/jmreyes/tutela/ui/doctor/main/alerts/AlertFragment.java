 ...
 */
public class AlertFragment extends BaseFragment implements AlertView {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_doctor_alerts, container, false);
...
//        mListener.loadActivity(OnFragmentInteractionListener.Subsections.DOCTOR_DETAILS, bundle, v);
    ...
    public void displayResults(List<Alert> results) {
        hideLoadingBar();
        alertAdapter = new AlertAdapter(listView.getContext(), results, this);
        listView.setAdapter(alertAdapter);
        mListener.updateNavigationDrawerUnseenAlerts(0);
    }
