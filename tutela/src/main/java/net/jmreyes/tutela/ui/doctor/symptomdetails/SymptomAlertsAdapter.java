...
import net.jmreyes.tutela.ui.doctor.main.symptoms.SymptomsView;
 ...
 */
public class SymptomAlertsAdapter extends ArrayAdapter<Symptom> {
    private final Context context;
    private final List<Symptom> values;

    private SymptomsView symptomsView;

    public SymptomAlertsAdapter(Context context, List<Symptom> values, SymptomsView symptomsView) {
